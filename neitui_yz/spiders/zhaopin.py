...
_GLB_SPIDER_NAME     = "zhaopin"
_GLB_ALLOWED_DOMAIN  = ["zhaopin.com"]
_GLB_START_POINT_URL = "http://sou.zhaopin.com/jobs/searchresult.ashx?sm=0&p=1&kw="
...
class NeituiSpider(scrapy.Spider):
    ...
    # http://my.oschina.net/HappyRoad/blog/174429
    # http://my.oschina.net/lpe234/blog/342741
    def start_requests(self):
        for url in _GLB_START_URL_LIST:
    ...
    def parse(self, response):
        ...
        for result in response.xpath('//div[@id="newlist_list_div"]/div[@id="newlist_list_content_table"]/table[@class="newlist"]'):
            print result
