...
_GLB_SPIDER_NAME     = "lagou"
_GLB_ALLOWED_DOMAIN  = ["lagou.com"]
_GLB_START_POINT_URL1= "http://www.lagou.com/jobs/list_"
_GLB_START_POINT_URL2= "?cl=false&fromSearch=true"
_GLB_SEARCH_KEYWORDS = ["hadoop"] #, "Python", "大数据", "技术总监"]
_GLB_START_URL_LIST  = [_GLB_START_POINT_URL1+_keyword+_GLB_START_POINT_URL2 for _keyword in _GLB_SEARCH_KEYWORDS]
